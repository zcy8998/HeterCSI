...
datasets = {
    ...
    {0.9,    64,   15,     16,  1.00,     [1,2],      '3GPP_38.901_RMa_LOS',           [0,120]};
    {3.5,   128,   30,     24,  0.39,     [2,4],      '3GPP_38.901_UMi_LOS',           [3,80]};
    {4.2,    32,   30,     16,  2.57,     [2,2],      '3GPP_38.901_Indoor_NLOS',       [0,10]};
    {5.1,    64,   30,     24,  0.21,     [2,8],      '3GPP_38.901_UMa_NLOS',          [30,100]};
    {24.5,  128,  120,     24,  0.0367,   [4,4],      '3GPP_38.901_RMa_NLOS',           [0,120]};
    {27.5,   64,  120,     24,  0.0327,   [4,4],      '3GPP_38.901_UMi_NLOS',           [3,120]};
    {38.0,  128,  120,     32,  0.0568,   [2,4],      '3GPP_38.901_UMi_LOS',           [3,50]};
    {60.0,  128,  240,     16,  0.0150,   [4,4],      '3GPP_38.901_UMa_LOS',        [0,120]};
    };
