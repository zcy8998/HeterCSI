% matlab -nodisplay -nosplash -nodesktop -r "addpath('/home/zhangchenyu/code/quadriga_src'); run('/home/zhangchenyu/code/CSIGPT/csi_train_sub6.m'); exit;"
% clc; clear; close all;
...
datasets = {
    ...
    {2.1,      128, 60,    24, 1,    [2,4],   '3GPP_38.901_UMi_NLOS', [3,50]};
    {2.1,      128, 60,    24, 0.5,  [2,4],   '3GPP_38.901_RMa_NLOS', [60,200]};
    {2.1,      256, 15,    32, 1,    [1,4],   '3GPP_38.901_Indoor_LOS', [0,10]};
    {2.1,      32,  120,   16, 0.5,  [4,8],   '3GPP_38.901_UMa_LOS', [30,100]};
    {2.5,      64,  120,   24, 0.5,  [2,2],   '3GPP_38.901_RMa_NLOS', [30,100]};
    {2.5,      256, 30,    24, 1,    [2,4],   '3GPP_38.901_UMi_LOS', [3,50]};
    {2.5,      32,  120,   16, 0.5,  [4,8],   '3GPP_38.901_UMa_LOS', [30,100]};
    {2.5,      256, 30,    16, 1,    [2,4],   '3GPP_38.901_Indoor_NLOS', [0,10]};
    {2.6,      128, 120,   32, 1,    [1,4],   '3GPP_38.901_UMi_NLOS', [3,50]};
    {2.6,      64,  60,    24, 0.5,  [2,4],   '3GPP_38.901_RMa_LOS', [120,300]};
    {2.6,      64,  60,    16, 0.5,  [4,4],   '3GPP_38.901_UMa_NLOS', [30,100]};
    {2.6,      32,  120,   16, 1,    [4,8],   '3GPP_38.901_Indoor_LOS', [0,10]};
    {4.9,      256, 30,    24, 0.5,  [2,4],   '3GPP_38.901_RMa_LOS', [60,200]};
    {4.9,      128, 120,   24, 1,    [2,4],   '3GPP_38.901_UMi_NLOS', [3,50]};
    {4.9,      64,  120,   32, 1,    [4,4],   '3GPP_38.901_Indoor_LOS', [0,10]};
...
% 创建输出目录
output_dir = '/Users/chenyuzhang/Desktop/csidata/sub6';
...
for dataset_id = 1:length(datasets)
    ...
    % 预分配存储空间 (单精度复数减少内存占用)
    H_train = zeros(num_train, T, K, Ant*2, 'single');
    speed_train = zeros(num_train, 1);
    
    H_val = zeros(num_val, T, K, Ant*2, 'single');
    speed_val = zeros(num_val, 1);
    
    H_test = zeros(num_test, T, K, Ant*2, 'single');
    ...
    for sample_id = 1:samples_per_dataset
        ...
        % 生成基站天线阵列
        BSAntArray = qd_arrayant.generate('3gpp-3d', M_BS, N_BS, fc, 2, ElcTltAgl_BS, 0.5);
        
        % 生成用户天线 (单天线)
        UEAntArray = qd_arrayant.generate('3gpp-3d', 1, 1, fc, 1);
