...
datasets_new = {
    ...
    % --- Indoor Scenarios ---
    {2.4,      64,  30,    16, 1.0,   [4,4],   '3GPP_38.901_Indoor_NLOS', [0,5]};     % D1 (Old D5)
    {39,       64,  480,   16, 0.0625,[4,4],   '3GPP_38.901_Indoor_NLOS', [0,10]};    % D2 (Old D14)
    {42,       32,  240,   24, 0.125, [2,4],   '3GPP_38.901_Indoor_NLOS', [0,10]};    % D3 (Old D4)
    % --- RMa Scenarios ---
    {2.6,      128, 60,    24, 0.5,   [2,4],   '3GPP_38.901_RMa_LOS',     [100,200]}; % D4 (Old D21)
    {4.8,      128, 240,   24, 0.25,  [2,4],   '3GPP_38.901_RMa_NLOS',    [3,60]};    % D5 (Old D16)
    {37.5,     128, 120,   24, 0.25,  [2,4],   '3GPP_38.901_RMa_NLOS',    [3,50]};    % D6 (Old D3)
    % --- UMa Scenarios ---
    {2.1,      32,  120,   16, 0.5,   [4,8],   '3GPP_38.901_UMa_LOS',     [30,120]};  % D7 (Old D20)
    {26.5,     128, 60,    24, 0.5,   [2,8],   '3GPP_38.901_UMa_LOS',     [10,40]};   % D8 (Old D11)
    {42,       32,  240,   16, 0.125, [4,8],   '3GPP_38.901_UMa_LOS',     [30,100]};  % D9 (Old D22)
    % --- UMi Scenarios ---
    {2.1,      128, 360,   24, 1,     [2,4],   '3GPP_38.901_UMi_NLOS',    [3,50]};    % D10 (Old D18)
    {6.2,      128, 240,   24, 0.5,   [2,4],   '3GPP_38.901_UMi_NLOS',    [20,80]};   % D11 (Old D23)
    {29.0,     128, 120,   24, 0.125, [2,8],   '3GPP_38.901_UMi_LOS',     [30,80]};   % D12 (Old D12)
};
...
% 创建输出目录
output_dir = '/Users/chenyuzhang/Desktop/CrossCSI/dataset/small_model_train_final';
