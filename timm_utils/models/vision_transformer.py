...
from timm_utils.data import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD, IMAGENET_INCEPTION_MEAN, IMAGENET_INCEPTION_STD
...
class Block(nn.Module):
    ...
    def forward(self, x, alibi=None):
        if alibi is None:
            alibi = torch.zeros((x.shape[0], x.shape[1], x.shape[1]), device=x.device, dtype=x.dtype)
